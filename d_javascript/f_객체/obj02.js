...
// 2) 객체의 메서드 안의 this
// : 객체의 변수에 할당되는 함수
// - 메서드 호출 시 this는 해당 메서드를 호출한 객체에 바인딩
...
const person1 = new Person('문창배1'); // this.name = '문창배1'
const person2 = new Person('문창배2'); // this.name = '문창배2'
...
const arrowObject = {
  name: 'object',
  showThis: () => {
    // 화살표 함수가 정의된 객체의 생성 스코프를 this가 가져옴
    console.log(this);
  }
}
