...
class Library {
  ...
  countAvailableBooks() {
    ...
    console.log(`총 ${count}권의 책이 대여 가능`);
    return count;
  }
}
...
busanLibrary.addBook('SQLD 공부는 재밌어', '문창배1');
busanLibrary.addBook('자바 공부는 재밌어', '문창배2');
busanLibrary.addBook('자바스크립트 공부는 재밌어', '문창배3');
busanLibrary.addBook('리액트 공부는 재밌어', '문창배4');
busanLibrary.addBook('스프링 공부는 재밌어', '문창배5');
...
yangsanLibrary.addBook('정보처리기사 정복하기', '문창배1');
yangsanLibrary.addBook('컴퓨터활용능력 정복하기', '문창배2');
yangsanLibrary.addBook('빅데이터분석기사 정복하기', '문창배3');

yangsanLibrary.displayBooks();

busanLibrary.filterBooksByAuthor('문창배1');
// === 문창배1의 책 목록 ===
// 1: SQLD 공부는 재밌어 - 대여가능
...
// === 대여 가능인 책 목록 ===
// 2: 자바 공부는 어려워 by 문창배2
// 5: 스프링 공부는 재밌어 by 문창배5


busanLibrary.filterBooksByAvailable(false);
// === 대여 중인 책 목록 ===
// 1: SQLD 공부는 재밌어 by 문창배1
// 4: 리액트 공부는 재밌어 by 문창배4
