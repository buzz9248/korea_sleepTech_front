...
else if (num === 0) console.log('0 입니다.');
...
// 70이상 C
// 60이상 D
// 그 외의 경우 F >> 각 학점의 값을 grade 변수에 대입
let score;
let grade;

console.log('=== switch문 ===');
// : 조건식에 true (조건의 결과가 true인 경우) 각각 case에 조건 사용(대입)
score = 35;
...
score = 79;
if (score > 100 || score < 0) console.log('유효한 점수가 아닙니다.');
