...
console.log(`제곱근(square root): ${Math.sqrt(256)}`);

//# 5. Date 객체: 날짜, 시간 데이터 객체

// 현재 날짜와 시간 반환
let now = new Date();
console.log(now); // 2025-03-18T06:42:23.357Z // 그리니치 천문대 시간 (우리나라: +9h 해야함)
...
console.log(now.toLocaleTimeString()); // 오후 3:49:16