...
function TodoAppLocalStorage() {
  ...
  return (
    <div className='app'>
      <h1>Todo List</h1>
      <input type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} onKeyDown={(e) => e.key === 'Enter' ? addTodo() : null} />
      <button onClick={addTodo}>Add Todo</button>
      <TodoList todos={todos} toggleTodo={toggleTodoCompleted} deleteTodo={deleteTodo} />
    </div>
  )
}
